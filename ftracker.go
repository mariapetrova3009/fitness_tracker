...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	...
	calories := ((runningCaloriesMeanSpeedMultiplier * speed * runningCaloriesMeanSpeedShift) *
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	// ваш код здесь
	var speed = meanSpeed(action, duration) * kmhInMsec
	calories := ((walkingCaloriesWeightMultiplier*weight + (math.Pow(speed, 2)/(height/100))*
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	// ваш код здесь
	var speed = swimmingMeanSpeed(lengthPool, countPool, duration)
	calories := (speed + swimmingCaloriesMeanSpeedShift) * swimmingCaloriesWeightMultiplier *
		weight * duration
	return calories
